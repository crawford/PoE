...
//   <hex address> [<hex value>]                                   Read/[Write] address
//   phy <hex reg> [<hex value>]                                   Read/[Write] PHY register
//   eth <hex offset> [<hex value>]                                Read/[Write] address in ETH peripheral
//   gpio <hex offset> [<hex value>]                               Read/[Write] address in GPIO peripheral
//   gpio <port name> <port register> [<hex value>]                Read/[Write] port register in GPIO peripheral
//   gpio <port name> <pin> <port register> [<hex value>]          Read/[Write] pin in port register in GPIO peripheral
...
static mut PROGRAM_SPACE: [u8; 1024] = [0; 1024];
